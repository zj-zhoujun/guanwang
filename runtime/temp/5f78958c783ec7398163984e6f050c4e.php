<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"./application/en/view/default/pc/index\index.html";i:1491016681;s:49:"./application/en/view/default/pc/public\head.html";i:1491018343;s:49:"./application/en/view/default/pc/public\foot.html";i:1490941258;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="owl-carousel owl-carousel5">
                    ...
                    <div>
                        <div class="product-item">
                            ...
                            <h3 class="text-center"><a href="<?php echo url('/en/'.$rs['urlroute'].'-p'.$rs['id']); ?>"><?php echo $rs['title']; ?></a></h3>
        ...
        <div class="row margin-bottom-40 ">
            ...
            <div class="sidebar col-md-4 col-sm-4">
                ...
                <ul class="list-group sidebar-menu">
                    <?php $result = db("news")->where("lang='en' and find_in_set('view',status)")->limit("10")->order("addtime desc")->select();$__LIST__ = $result; if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                        <li class="list-group-item clearfix"><a href="<?php echo url('/en/'.$rs['urlroute'].'-n'.$rs['id']); ?>"><i class="fa fa-angle-right"></i><?php echo msubstr($rs['title'],0,38); ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <a href="<?php echo url('/en/news/index-1'); ?>" class="col-md-12 btn btn-default">&raquo; <?php echo \think\Lang::get('v_more'); ?> <?php echo \think\Lang::get('v_news'); ?></a>
            </div>
            <!--新闻动态 结束-->
            <!--关于我们 开始-->
            <div class="col-md-8 col-sm-8">
                <h3 class="clearfix"><div class="pull-left"><?php echo \think\Lang::get('about'); ?></div><div class="pull-right padding-top-10 font-size16"><a href="<?php echo url('/en/gongsijianjie-a227'); ?>">&raquo;<?php echo \think\Lang::get('v_detail'); ?></a></div></h3>
