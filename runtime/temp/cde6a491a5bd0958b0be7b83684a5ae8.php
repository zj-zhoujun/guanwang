<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:70:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\sort\index.html";i:1538386266;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\head.html";i:1538386297;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\left.html";i:1538386279;s:80:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\response_left.html";i:1538386274;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\foot.html";i:1538386246;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>
						    <?php switch($modulenav['id']): case "1": ?><?php echo \think\Lang::get('v_product'); break; case "2": ?><?php echo \think\Lang::get('v_news'); break; case "3": ?><?php echo \think\Lang::get('v_down'); break; case "4": ?><?php echo \think\Lang::get('v_about_module'); break; case "5": ?><?php echo \think\Lang::get('v_project'); break; default: ?><?php echo $modulenav['modulename']; endswitch; ?>
                                <?php echo \think\Lang::get('v_manage'); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span>
						    <?php switch($modulenav['id']): case "1": ?><?php echo \think\Lang::get('v_product'); break; case "2": ?><?php echo \think\Lang::get('v_news'); break; case "3": ?><?php echo \think\Lang::get('v_down'); break; case "4": ?><?php echo \think\Lang::get('v_about_module'); break; case "5": ?><?php echo \think\Lang::get('v_project'); break; default: ?><?php echo $modulenav['modulename']; endswitch; ?>
                            <?php echo \think\Lang::get('v_sort'); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <div class="col-md-8">
                            <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo url('Sort/edit?moduleid='.$moduleid.'&lang='.input('get.lang')); ?>'"><?php echo \think\Lang::get('v_add'); ?> <?php echo \think\Lang::get('v_sort'); ?></button>
                        </div>
                        <form name="form1" action="" method="post">
                            <input type="hidden" name="lan" value="<?php echo input('get.lan'); ?>">
                            <div class="col-md-4 input-group">
                                <input type="text" name="keyword" class="form-control" placeholder="<?php echo \think\Lang::get('v_quickfind'); ?>" />
                                <span class="input-group-btn pdr5"><button type="submit" class="btn blue"><?php echo \think\Lang::get('v_search'); ?></button></span>
                            </div>
                        </form>
                    </div>
                            ...
                            <tbody>
                              <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="<?php echo url('Sort/edit?moduleid='.$rs['moduleid'].'&id='.$rs['id'].'&lang='.input('get.lang')); ?>" class="btn green btn-sm"><i class="fa fa-edit"></i> <?php echo \think\Lang::get('v_edit'); ?></a><a class="btn red-flamingo btn-sm" onClick='return confirm("<?php echo \think\Lang::get('v_confirm_delete'); ?>！");' href="<?php echo url('sort/delete_one?id='.$rs['id']); ?>"><i class="fa fa-times"></i> <?php echo \think\Lang::get('v_delete'); ?></a></td>
                                </tr>
                              <?php endforeach; endif; else: echo "" ;endif; ?>
                                <tr>
                                    <td colspan="4">
                                        <div class="col-md-7"><div class="pull-left lh31 pdl5"><?php echo \think\Lang::get('v_total'); ?> <?php echo $total; ?> <?php echo \think\Lang::get('v_records'); ?></div></div>
                                        <div class="col-md-5"><div class="pull-right"><button type="button" class="btn blue" onclick="CheckOthers(this.form);"><i class="fa fa-check"></i> <?php echo \think\Lang::get('v_select_all'); ?></button><button type="button" class="btn green" onClick='ConfirmDel("","<?php echo url('sort/update_all'); ?>","update");'><i class="fa fa-arrow-circle-o-up"></i> <?php echo \think\Lang::get('v_update_all'); ?></button><button type="button" class="btn red-flamingo" onClick='ConfirmDel("<?php echo \think\Lang::get('v_confirm_delete'); ?>！","<?php echo url('sort/delete_all'); ?>","delete");'><i class="fa fa-times"></i> <?php echo \think\Lang::get('v_delete_select'); ?></button></div></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
