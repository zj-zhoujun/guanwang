<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:68:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\ad\index.html";i:1538386280;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\head.html";i:1538386297;s:78:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\global_left.html";i:1538386277;s:80:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\response_left.html";i:1538386274;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\foot.html";i:1538386246;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo \think\Lang::get('v_global'); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php echo \think\Lang::get('v_ad'); ?> <?php echo \think\Lang::get('v_manage'); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo url('Ad/edit?lang='.input('get.lang')); ?>'"><?php echo \think\Lang::get('v_add'); ?> <?php echo \think\Lang::get('v_ad'); ?></button>
                    </div>
                    <form name="form2" id="form2" action="" method="post">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column">
                            <thead>
                                <tr class="bg-default">
                                    <th>ID</th>
                                    <th><?php echo \think\Lang::get('v_title'); ?></th>
                                    <th><?php echo \think\Lang::get('v_img'); ?></th>
                                    <th><?php echo \think\Lang::get('v_type'); ?></th>
                                    <th><?php echo \think\Lang::get('v_position'); ?></th>
                                    <?php if(!\think\Request::instance()->isMobile()): ?><th><?php echo \think\Lang::get('v_sequence'); ?></th><?php endif; ?>
                            ...
                            <tbody>
                              <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a href="<?php echo $rs['thumb']; ?>" target="_blank"><img src="<?php echo $rs['thumb']; ?>" <?php if(!\think\Request::instance()->isMobile()): ?>width="300"<?php else: ?>width="50" height="50"<?php endif; ?> border="0" /></a></td>
                                    <td>
						                <?php switch($rs['typeid']): case "1": ?><?php echo \think\Lang::get('v_banner'); break; case "2": ?><?php echo \think\Lang::get('v_friendlink'); break; default: ?><?php echo \think\Lang::get('v_banner'); endswitch; ?>
                                    </td>
                                    <td>
						                <?php switch($rs['position']): case "Index": ?><?php echo \think\Lang::get('v_index'); break; case "Product": ?><?php echo \think\Lang::get('v_product'); break; case "News": ?><?php echo \think\Lang::get('v_news'); break; case "Down": ?><?php echo \think\Lang::get('v_down'); break; case "About": ?><?php echo \think\Lang::get('v_about_module'); break; case "Project": ?><?php echo \think\Lang::get('v_project'); break; default: ?><?php echo $rs['position']; endswitch; ?><?php echo \think\Lang::get('v_module'); ?>&nbsp;&nbsp;
                                    </td>
                                    <?php if(!\think\Request::instance()->isMobile()): ?><td><input name="sequence[]" type="text" value="<?php echo $rs['sequence']; ?>" class="form-control input-sm" onKeyDown="if(event.keyCode==13)event.returnValue=false" onChange="if(/\D/.test(this.value)){alert('<?php echo \think\Lang::get('v_require_number'); ?>！');this.value='0';}" /></td><?php endif; ?>
                                    <td><a href="<?php echo url('Ad/edit?id='.$rs['id'].'&lang='.input('get.lang')); ?>" class="btn green btn-sm"><i class="fa fa-edit"></i> <?php echo \think\Lang::get('v_edit'); ?></a><a class="btn red-flamingo btn-sm" onClick='return confirm("<?php echo \think\Lang::get('v_confirm_delete'); ?>！");' href="<?php echo url('ad/delete_one?id='.$rs['id']); ?>"><i class="fa fa-times"></i> <?php echo \think\Lang::get('v_delete'); ?></a></td>
                                </tr>
                              <?php endforeach; endif; else: echo "" ;endif; ?>
                                <tr>
                                    <td colspan="7">
                                        ...
                                        <div class="col-md-5"><div class="pull-right"><button type="button" class="btn blue" onclick="CheckOthers(this.form);"><i class="fa fa-check"></i> <?php echo \think\Lang::get('v_select_all'); ?></button><?php if(!\think\Request::instance()->isMobile()): ?><button type="button" class="btn green" onClick='ConfirmDel("","<?php echo url('ad/update_all'); ?>","update");'><i class="fa fa-arrow-circle-o-up"></i> <?php echo \think\Lang::get('v_update_all'); ?></button><?php endif; ?><button type="button" class="btn red-flamingo" onClick='ConfirmDel("<?php echo \think\Lang::get('v_confirm_delete'); ?>！","<?php echo url('ad/delete_all'); ?>","delete");'><i class="fa fa-times"></i> <?php echo \think\Lang::get('v_delete_select'); ?></button></div></div>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
