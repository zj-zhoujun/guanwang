<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:75:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\auth_rule\index.html";i:1538386272;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\head.html";i:1538386297;s:78:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\global_left.html";i:1538386277;s:80:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\response_left.html";i:1538386274;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\foot.html";i:1538386246;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo \think\Lang::get('v_auth_manage'); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <div class="col-md-8">
                            <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo url('AuthRule/edit?lang='.input('get.lang')); ?>'"><?php echo \think\Lang::get('v_add'); ?> <?php echo \think\Lang::get('v_auth'); ?></button>
                        </div>
                    ...
                    <form name="form2" id="form2" action="" method="post">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column">
                            <thead>
                                <tr class="bg-default">
                                    <th>ID</th>
                                    <th><?php echo \think\Lang::get('v_auth_name'); ?></th>
                                    <th><?php echo \think\Lang::get('v_auth_value'); ?></th>
                            ...
                            <tbody>
                              <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="<?php echo url('AuthRule/edit?lang='.input('get.lang').'&id='.$rs['id']); ?>" class="btn green btn-sm"><i class="fa fa-edit"></i> <?php echo \think\Lang::get('v_edit'); ?></a>
                                        <a class="btn red-flamingo btn-sm" onClick='return confirm("<?php echo \think\Lang::get('v_confirm_delete'); ?>！");' href="<?php echo url('authRule/delete_one?id='.$rs['id']); ?>"><i class="fa fa-times"></i> <?php echo \think\Lang::get('v_delete'); ?></a>
                                    </td>
                                </tr>
                              <?php endforeach; endif; else: echo "" ;endif; ?>
                                <tr>
