<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:50:"./application/en/view/default/pc/product\view.html";i:1493446653;s:49:"./application/en/view/default/pc/public\head.html";i:1491018343;s:49:"./application/en/view/default/pc/public\foot.html";i:1490941258;}*/ ?>
<!DOCTYPE html>
...
<div class="header">
    <div class="container">
        <a class="site-logo" href="/en/"><img src="<?php echo $siteRs['logo']; ?>" alt="<?php echo $siteRs['sitetitle']; ?>"></a>
...
<div class="main">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo url('/en/product/index-1'); ?>"><?php echo \think\Lang::get('product'); ?></a></li>
            <?php if(is_array($listnavigation) || $listnavigation instanceof \think\Collection || $listnavigation instanceof \think\Paginator): $i = 0; $__LIST__ = $listnavigation;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$proSortRs): $mod = ($i % 2 );++$i;?>
                <li class="active"><a href="<?php echo url('/en/'.$proSortRs['urlroute'].'-p'.$proSortRs['id'].'-1'); ?>"><?php echo $proSortRs['title']; ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <!--侧边栏和内容 开始-->
        <div class="row margin-bottom-40">
            ...
            <div class="sidebar col-md-3 col-sm-5">
                <ul class="list-group margin-bottom-25 sidebar-menu">
                    <?php if(is_array($moduleSort) || $moduleSort instanceof \think\Collection || $moduleSort instanceof \think\Paginator): $i = 0; $__LIST__ = $moduleSort;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$productSortRs): $mod = ($i % 2 );++$i;if(empty($productSortRs['sub']) || (($productSortRs['sub'] instanceof \think\Collection || $productSortRs['sub'] instanceof \think\Paginator ) && $productSortRs['sub']->isEmpty())): ?>
                            <li class="list-group-item clearfix"><a href="<?php echo url('/en/'.$productSortRs['urlroute'].'-p'.$productSortRs['id'].'-1'); ?>"><i class="fa fa-angle-right"></i><?php echo $productSortRs['title']; ?></a></li>
                        <?php else: ?>
                            <li class="list-group-item clearfix dropdown active">
                                <a href="<?php echo url('/en/'.$productSortRs['urlroute'].'-p'.$productSortRs['id'].'-1'); ?>" class="collapsed"><i class="fa fa-angle-right"></i><?php echo $productSortRs['title']; ?><i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" style="display:block;">
                                    <?php if(is_array($productSortRs['sub']) || $productSortRs['sub'] instanceof \think\Collection || $productSortRs['sub'] instanceof \think\Paginator): $i = 0; $__LIST__ = $productSortRs['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$subRs): $mod = ($i % 2 );++$i;if(empty($subRs['subsub']) || (($subRs['subsub'] instanceof \think\Collection || $subRs['subsub'] instanceof \think\Paginator ) && $subRs['subsub']->isEmpty())): ?>
                                            <li class="list-group-item clearfix"><a href="<?php echo url('/en/'.$subRs['urlroute'].'-p'.$subRs['id'].'-1'); ?>"><i class="fa fa-angle-right"></i><?php echo $subRs['title']; ?></a></li>
                                        <?php else: ?>
                                            <li class="list-group-item dropdown clearfix">
                                                <a href="<?php echo url('/en/'.$subRs['urlroute'].'-p'.$subRs['id'].'-1'); ?>"><i class="fa fa-angle-right"></i><?php echo $subRs['title']; ?><i class="fa fa-angle-down"></i></a>
                                                <ul class="dropdown-menu" style="display:block;">
                                                    <?php if(is_array($subRs['subsub']) || $subRs['subsub'] instanceof \think\Collection || $subRs['subsub'] instanceof \think\Paginator): $i = 0; $__LIST__ = $subRs['subsub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$subsubRs): $mod = ($i % 2 );++$i;?>
                                                        <li class="list-group-item clearfix"><a href="<?php echo url('/en/'.$subsubRs['urlroute'].'-p'.$subsubRs['id'].'-1'); ?>"><i class="fa fa-angle-right"></i><?php echo $subsubRs['title']; ?></a></li>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </ul>
                                            </li>
                                        <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div class="sidebar-products clearfix">
                    ...
                    <?php $result = db("product")->where("sortid in($sortidArr) and lang='en' and find_in_set('view',status)")->limit("6")->order("hits desc,sequence desc")->select();$__LIST__ = $result; if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                        <div class="item">
                            <a href="<?php echo url('/en/'.$rs['urlroute'].'-p'.$rs['id']); ?>"><img src="<?php echo $rs['thumb']; ?>" alt="<?php echo $rs['title']; ?>"></a>
                            <h3><a href="<?php echo url('/en/'.$rs['urlroute'].'-p'.$rs['id']); ?>"><?php echo $rs['title']; ?></a></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="price-availability-block clearfix">
                                <div class="price">
                                    <strong><span>$</span><?php echo $rs['price']; ?></strong>
                                    <em>$<span><?php echo $rs['marketprice']; ?></span></em>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="pi-img-wrapper">
                                ...
                                <div>
                                    ...
                                    <a href="<?php echo url('/en/'.$rs['urlroute'].'-p'.$rs['id']); ?>" class="btn btn-default fancybox-fast-view"><?php echo \think\Lang::get('v_detail'); ?></a>
                                </div>
                            </div>
                            <h3><a href="<?php echo url('/en/'.$rs['urlroute'].'-p'.$rs['id']); ?>"><?php echo $rs['title']; ?></a></h3>
                            <div class="pi-price">$<?php echo $rs['price']; ?></div>
                            <a href="<?php echo url('/en/'.$rs['urlroute'].'-p'.$rs['id']); ?>" class="btn btn-default add2cart">&raquo;<?php echo \think\Lang::get('v_detail'); ?></a>
                        </div>
                    </div>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
...
<div class="pre-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-6 pre-footer-col">
                ...
                <ul class="list-unstyled">
                    <?php $result = db("about")->where("lang='en' and parentid<>0")->limit("6")->order("sequence desc,id desc")->select();$__LIST__ = $result; if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                        <li><i class="fa fa-angle-right"></i> <a href="<?php echo url('/en/'.$rs['urlroute'].'-a'.$rs['id']); ?>"><?php echo $rs['title']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
            <!--底部关于我们 结束-->
            ...
            <div class="col-md-2 col-sm-6 pre-footer-col">
                ...
                <ul class="list-unstyled">
                    <?php $result = db("sort")->where("lang='en' and moduleid=1 and parentid=0")->limit("6")->order("sequence desc,id desc")->select();$__LIST__ = $result; if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                        <li><i class="fa fa-angle-right"></i> <a href="<?php echo url('/en/'.$rs['urlroute'].'-p'.$rs['id'].'-1'); ?>"><?php echo $rs['title']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <li><i class="fa fa-angle-right"></i> <a href="<?php echo url('/en/product/index-1'); ?>"><?php echo \think\Lang::get('v_more'); ?></a></li>
                </ul>
            </div>
            <!--底部产品中心 结束-->
            <!--底部新闻动态 开始-->
            <div class="col-md-2 col-sm-6 pre-footer-col">
                ...
                <ul class="list-unstyled">
                    <?php $result = db("sort")->where("lang='en' and moduleid=2 and parentid=0")->limit("6")->order("sequence desc,id desc")->select();$__LIST__ = $result; if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                        <li><i class="fa fa-angle-right"></i> <a href="<?php echo url('/en/'.$rs['urlroute'].'-n'.$rs['id'].'-1'); ?>"><?php echo $rs['title']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
            <!--底部新闻动态 结束-->
        ...
        <div class="row col-md-12 margin-bottom-10">
            ...
            <?php $result = db("ad")->where("lang='en' and typeid=2")->limit("35")->order("sequence desc,id desc")->select();$__LIST__ = $result; if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
...
<div class="footer">
    <div class="container">
        <div class="row">
            <!--左侧 开始-->
            <div class="col-md-8 col-sm-8 padding-top-5"><?php echo htmlspecialchars_decode($copyright); ?></div>
            <!--左侧 结束-->
            <!--右侧 开始-->
...
<div id="top">
    <div id="izl_rmenu" class="izl-rmenu">
        ...
        <div class="kfbtn btn-qq">
            <div class="qq">
                <?php $result = db("chat")->where("lang='en' and typeid='msn'")->limit("5")->order("sequence desc,id desc")->select();$__LIST__ = $result; if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                    <a rel="nofollow" target="_blank" href="msnim:chat?contact=<?php echo $rs['account']; ?>"><img src="<?php echo $rs['thumb']; ?>" alt="<?php echo $rs['title']; ?>" class="margin-right-10" /><?php echo $rs['title']; ?></a>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
...
<script src="__PUBLIC__/js/global.js" type="text/javascript"></script><!--在线客服-->
