<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:72:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\module\index.html";i:1538386270;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\head.html";i:1538386297;s:78:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\global_left.html";i:1538386277;s:80:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\response_left.html";i:1538386274;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\foot.html";i:1538386246;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo \think\Lang::get('v_module_manage'); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                    ...
                    <div class="col-md-12 margin-top-10 margin-bottom-10">
                        <button type="button" class="btn green" onclick="javascript:window.location.href='<?php echo url('Module/edit?lang='.input('get.lang')); ?>'"><?php echo \think\Lang::get('v_add'); ?> <?php echo \think\Lang::get('v_module'); ?></button>
                    </div>
                    <form name="form2" id="form2" action="" method="post">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column">
                            <thead>
                                <tr class="bg-default">
                                    <th>ID</th>
                                    <th><?php echo \think\Lang::get('v_module_name'); ?></th>
                                    <th><?php echo \think\Lang::get('v_module_mulu'); ?></th>
                                    <th><?php echo \think\Lang::get('v_listnum'); ?></th>
                            ...
                            <tbody>
                              <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?>
                                ...
                                <tr class="odd gradeX">
                                    <td><?php if($rs['id'] > '6'): ?><input type="checkbox" name="selectid[]" id="selectid" value="<?php echo $rs['id']; ?>" /> <?php endif; ?><?php echo $rs['id']; ?></td>
                                    <td>
                                        <?php switch($rs['id']): case "1": ?><?php echo \think\Lang::get('v_product'); break; case "2": ?><?php echo \think\Lang::get('v_news'); break; case "3": ?><?php echo \think\Lang::get('v_about_module'); break; case "4": ?><?php echo \think\Lang::get('v_project'); break; case "5": ?><?php echo \think\Lang::get('v_down'); break; default: ?><?php echo $rs['title']; endswitch; ?><?php echo \think\Lang::get('v_module'); ?>
                                    </td>
                                    <td><?php echo $rs['tabledir']; ?></td>
                                    <td>
                                        <input name="listnum[]" type="text" value="<?php echo $rs['listnum']; ?>" class="form-control input-sm" onKeyDown="if(event.keyCode==13)event.returnValue=false" onChange="if(/\D/.test(this.value)){alert('<?php echo \think\Lang::get('v_require_number'); ?>！');this.value='0';}" />
                                    </td>
                                    ...
                                    <td>
                                        <?php if($rs['disabled'] == '1'): ?><a onClick='return confirm("<?php echo \think\Lang::get('v_enable_cancel'); ?>？");' href="<?php echo url('Module/update_disabled?value=0&id='.$rs['id']); ?>" class="btn green btn-sm"><?php echo \think\Lang::get('v_enable'); ?></a>
                                            <else/><a onClick='return confirm("<?php echo \think\Lang::get('v_enable_makesure'); ?>？");' href="<?php echo url('Module/update_disabled?value=1&id='.$rs['id']); ?>" class="btn red-flamingo btn-sm"><?php echo \think\Lang::get('v_disable'); ?></a>
                                        <?php endif; ?>
                                    </td>
	                                <td><a href="<?php echo url('Module/edit?lang='.input('get.lang').'&id='.$rs['id']); ?>" class="btn green btn-sm"><?php echo \think\Lang::get('v_edit'); ?></a>
						                <?php if($rs['id'] < '6'): ?>
                                            <span class="btn default btn-sm"><?php echo \think\Lang::get('v_cannot_delete'); ?></span>
                                        <?php else: ?>
                                            <a onClick='return confirm("<?php echo \think\Lang::get('v_confirm_delete'); ?>！");' href="<?php echo url('module/delete_one?id='.$rs['id']); ?>" class="btn red-flamingo btn-sm"><?php echo \think\Lang::get('v_delete'); ?></a>
                                        <?php endif; ?>
					                </td>
                                </tr>
                              <?php endforeach; endif; else: echo "" ;endif; ?>
