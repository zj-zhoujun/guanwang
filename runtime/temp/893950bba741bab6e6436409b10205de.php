<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:67:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\ad\edit.html";i:1538386295;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\head.html";i:1538386297;s:78:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\global_left.html";i:1538386277;s:80:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\response_left.html";i:1538386274;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\foot.html";i:1538386246;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo \think\Lang::get('v_global'); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php echo \think\Lang::get('v_ad'); ?> <?php echo \think\Lang::get('v_manage'); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php if($rs['id'] == ''): ?><?php echo \think\Lang::get('v_add'); else: ?><?php echo \think\Lang::get('v_edit'); endif; ?> <?php echo \think\Lang::get('v_ad'); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                                    ...
                                    <div class="portlet-body">
                                        <div class="tabbable-bordered">
                                            <div class="edit_nav_left">
                                                <i class="fa fa-edit font-white"></i> <span class="font-white"><?php if($rs['id'] == ''): ?><?php echo \think\Lang::get('v_add'); else: ?><?php echo \think\Lang::get('v_edit'); endif; ?> <?php echo \think\Lang::get('v_ad'); ?></span>
                                            </div>
                                                ...
                                                <div class="tab-pane active" id="tab_general">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_title'); ?></label>
                                                            <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-group"><input type="text" name="thumb" id="morepics1" value="<?php echo $rs['thumb']; ?>" class="form-control" /><span class="input-group-btn"><input type="button" onClick="upImage1();" value=" <?php echo \think\Lang::get('v_upload_img'); ?> " class="btn green" /></span></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_linkurl'); ?></label>
                                                            <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_type'); ?></label>
                                                            <div class="radio-list">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="typeid" id="optionsRadios1" value="1"<?php if(($rs['typeid'] == 1) or $rs['typeid'] == ''): ?> checked="checked"<?php endif; ?> /> <?php echo \think\Lang::get('v_banner'); ?>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="typeid" id="optionsRadios1" value="2"<?php if($rs['typeid'] == 2): ?> checked="checked"<?php endif; ?> /><?php echo \think\Lang::get('v_friendlink'); ?>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_position'); ?></label>
                                                            <div class="radio-list">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="position" id="optionsRadios1" value="Index"<?php if(($rs['position'] == 'Index') or $rs['position'] == ''): ?> checked="checked"<?php endif; ?> /><?php echo \think\Lang::get('v_index'); ?>
                                                                </label>
                                                                <?php if(is_array($Module) || $Module instanceof \think\Collection || $Module instanceof \think\Paginator): $i = 0; $__LIST__ = $Module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ModuleRs): $mod = ($i % 2 );++$i;?>
                                                                    <label class="radio-inline">
                                                                        <input type="radio" name="position" id="optionsRadios1" value="<?php echo $ModuleRs['tabledir']; ?>"<?php if($rs['position'] == $ModuleRs['tabledir']): ?> checked="checked"<?php endif; ?> />
						                                                <?php switch($ModuleRs['id']): case "1": ?><?php echo \think\Lang::get('v_product'); break; case "2": ?><?php echo \think\Lang::get('v_news'); break; case "3": ?><?php echo \think\Lang::get('v_about_module'); break; case "4": ?><?php echo \think\Lang::get('v_project'); break; case "5": ?><?php echo \think\Lang::get('v_down'); break; default: ?> <?php echo $ModuleRs['modulename']; endswitch; ?> <?php echo \think\Lang::get('v_module'); ?>
                                                                    </label>
                                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                                            </div>
                                                        </div>
