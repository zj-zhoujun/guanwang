<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\siteinfo\index.html";i:1538386283;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\head.html";i:1538386297;s:78:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\global_left.html";i:1538386277;s:80:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\response_left.html";i:1538386274;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\foot.html";i:1538386246;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo \think\Lang::get('v_global'); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php echo \think\Lang::get('v_siteinfo'); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                                    ...
                                    <div class="portlet-body">
                                        <div class="tabbable-bordered">
                                            <div class="edit_nav_left">
                                                <i class="fa fa-edit font-white"></i> <span class="font-white"><?php echo \think\Lang::get('v_siteinfo'); ?></span>
                                            </div>
                                            <ul class="nav nav-tabs tabs-reversed">
                                                <li>
                                                    <a href="#tab_meta" data-toggle="tab"><?php echo \think\Lang::get('v_extend'); ?></a>
                                                </li>
                                                <li class="active">
                                                    <a href="#tab_general" data-toggle="tab"><?php echo \think\Lang::get('v_basic'); ?></a>
                                                </li>
                                            </ul>
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_general">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_site'); ?> <?php echo \think\Lang::get('v_title'); ?></label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="sitetitle" placeholder="<?php echo \think\Lang::get('v_seotitle_tips'); ?>" value="<?php echo $rs['sitetitle']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_site'); ?> <?php echo \think\Lang::get('v_keyword'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="sitekeyword" rows="2" class="form-control" placeholder="<?php echo \think\Lang::get('v_seokeyword_tips'); ?>"><?php echo $rs['sitekeyword']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_site'); ?> <?php echo \think\Lang::get('v_description'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="sitedescription" rows="3" class="form-control" placeholder="<?php echo \think\Lang::get('v_seodescription_tips'); ?>"><?php echo $rs['sitedescription']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_company'); ?></label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="company" value="<?php echo $rs['company']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_site'); ?> LOGO</label>
                                                            <div class="col-md-6">
                                                                <div class="input-group"><input type="text" name="logo" id="morepics1" value="<?php echo $rs['logo']; ?>" class="form-control" /><span class="input-group-btn"><input type="button" onClick="upImage1();" value=" <?php echo \think\Lang::get('v_upload_img'); ?> " class="btn green" /></span></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_icpnumber'); ?></label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="icpnumber" value="<?php echo $rs['icpnumber']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_htmlcode'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="htmlcode" rows="3" class="form-control" placeholder="<?php echo \think\Lang::get('v_htmlcode_tips'); ?>"><?php echo $rs['htmlcode']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_site'); ?> <?php echo \think\Lang::get('v_status'); ?></label>
                                                            <div class="radio-list col-md-9">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="sitestatus" id="optionsRadios1" value="1" <?php if($rs['sitestatus'] == '1'): ?>checked="checked" <?php endif; ?> /><?php echo \think\Lang::get('v_siteopen'); ?>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="sitestatus" id="optionsRadios1" value="0" <?php if($rs['sitestatus'] == '0'): ?>checked="checked" <?php endif; ?> /><?php echo \think\Lang::get('v_siteclose'); ?>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_closereason'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="closereason" id="content1a" style="width:100%; height:80px;"><?php echo $rs['closereason']; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab_meta">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_product'); ?> <?php echo \think\Lang::get('v_title'); ?></label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="producttitle" value="<?php echo $rs['producttitle']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_product'); ?> <?php echo \think\Lang::get('v_keyword'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="productkeyword" rows="2" class="form-control"><?php echo $rs['productkeyword']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_product'); ?> <?php echo \think\Lang::get('v_description'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="productdescription" rows="3" class="form-control"><?php echo $rs['productdescription']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_news'); ?> <?php echo \think\Lang::get('v_title'); ?></label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="newstitle" value="<?php echo $rs['newstitle']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_news'); ?> <?php echo \think\Lang::get('v_keyword'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="newskeyword" rows="2" class="form-control"><?php echo $rs['newskeyword']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_news'); ?> <?php echo \think\Lang::get('v_description'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="newsdescription" rows="3" class="form-control"><?php echo $rs['newsdescription']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_about_module'); ?> <?php echo \think\Lang::get('v_title'); ?></label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="abouttitle" value="<?php echo $rs['abouttitle']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_about_module'); ?> <?php echo \think\Lang::get('v_keyword'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="aboutkeyword" rows="2" class="form-control"><?php echo $rs['aboutkeyword']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_about_module'); ?> <?php echo \think\Lang::get('v_description'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="aboutdescription" rows="3" class="form-control"><?php echo $rs['aboutdescription']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_project'); ?> <?php echo \think\Lang::get('v_title'); ?></label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="projecttitle" value="<?php echo $rs['projecttitle']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_project'); ?> <?php echo \think\Lang::get('v_keyword'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="projectkeyword" rows="2" class="form-control"><?php echo $rs['projectkeyword']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_project'); ?> <?php echo \think\Lang::get('v_description'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="projectdescription" rows="3" class="form-control"><?php echo $rs['projectdescription']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_down'); ?> <?php echo \think\Lang::get('v_title'); ?></label>
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="downtitle" value="<?php echo $rs['downtitle']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_down'); ?> <?php echo \think\Lang::get('v_keyword'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="downkeyword" rows="2" class="form-control"><?php echo $rs['downkeyword']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_down'); ?> <?php echo \think\Lang::get('v_description'); ?></label>
                                                            <div class="col-md-6">
                                                                <textarea name="downdescription" rows="3" class="form-control"><?php echo $rs['downdescription']; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
