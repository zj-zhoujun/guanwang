<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:75:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\navigation\edit.html";i:1538386260;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\head.html";i:1538386297;s:78:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\global_left.html";i:1538386277;s:80:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\response_left.html";i:1538386274;s:71:"E:\phpstudy\WWW\1\5bb1e9ba11ab2/application/admin\view\public\foot.html";i:1538386246;}*/ ?>
<!--有理想的地方，地狱都是天堂-->
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span><?php echo \think\Lang::get('v_global'); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php echo \think\Lang::get('v_navigation'); ?> <?php echo \think\Lang::get('v_manage'); ?></span><i class="fa fa-angle-right"></i></li>
                            <li><span><?php if($rs['id'] == ''): ?><?php echo \think\Lang::get('v_add'); else: ?><?php echo \think\Lang::get('v_edit'); endif; ?> <?php echo \think\Lang::get('v_navigation'); ?></span></li>
                        </ul>
                    </div>
                    <!--页面导航 结束-->
                    <!--页面头部 结束-->
                                    ...
                                    <div class="portlet-body">
                                        <div class="tabbable-bordered">
                                            <div class="edit_nav_left">
                                                <i class="fa fa-edit font-white"></i> <span class="font-white"><?php if($rs['id'] == ''): ?><?php echo \think\Lang::get('v_add'); else: ?><?php echo \think\Lang::get('v_edit'); endif; ?> <?php echo \think\Lang::get('v_navigation'); ?></span>
                                            </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_general">
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_parent_sort'); ?></label>
                                                            <div class="col-md-4">
                                                                <select name="parentid" class="form-control" data-style="btn-primary">
                                                                    <option value=""><?php echo \think\Lang::get('v_top_sort'); ?></option>
                                                                    <?php if(is_array($Navigation) || $Navigation instanceof \think\Collection || $Navigation instanceof \think\Paginator): if( count($Navigation)==0 ) : echo "" ;else: foreach($Navigation as $key=>$v): ?>
                                                                        <option value="<?php echo $v['id']; ?>" <?php if($rs['parentid'] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo $v['html']; ?> <?php echo $v['title']; ?></option>
                                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3"><?php echo \think\Lang::get('v_istarget'); ?></label>
                                                            <div class="radio-list">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="outflag" id="optionsRadios1" value="1"<?php if($rs['outflag'] == 1): ?> checked="checked"<?php endif; ?> /> <?php echo \think\Lang::get('v_yes'); ?>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="outflag" id="optionsRadios1" value="0"<?php if($rs['outflag'] == 0): ?> checked="checked"<?php endif; ?> /><?php echo \think\Lang::get('v_no'); ?>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
